"""
Automated Pytest for palliative-care-esas-symptom-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PalliativecareesassymptomagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PalliativecareesassymptomagentEnrichmentSuite()
