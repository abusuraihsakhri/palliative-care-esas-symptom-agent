...
import pytest
from esas_palliative.models import FrontierPayload, ExecutionStatus
from esas_palliative.engine import FrontierDomainEngine
from esas_palliative.agents import ESASSymptomScoreAgent, DistressScoreTrajectoryAgent, PalliativePharmacotherapyAgent, ESASPalliativeCoordinator
from esas_palliative.cli import main


def test_sub_agents():
    a1 = ESASSymptomScoreAgent()
    ...
    a2 = DistressScoreTrajectoryAgent()
    ...
    a3 = PalliativePharmacotherapyAgent()
...
def test_coordinator():
    coord = ESASPalliativeCoordinator()
    ...
    assert "Edmonton Symptom Assessment System-revised (ESAS-r)" in ans or "specifications" in ans
