"""
Data Models & Telemetry Definitions for ESAS-Palliative: Edmonton Symptom Assessment System & Opioid Distress.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Edmonton Symptom Assessment System-revised (ESAS-r)"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
